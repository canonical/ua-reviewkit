...
The "source" key defines what to check against. If source is
"local" then the bundle setting value is checked against the value in the
assertion. The "bundle" source implies that all information needed is within
the bundle.

## Assertion Checks Schema
